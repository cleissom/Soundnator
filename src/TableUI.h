...
class TableSlider : public TableUIBase {
   ...
   public:
    ...
    TableSlider(float angle = 0.0f, float distanceOffset = 0.075f, bool discreteSlider = false,
                float sliderMaxValue = 100.0f, float sliderMinValue = 0.0f, int id = 0, float sliderSize = 1.0f,
                float circleSize = 1.0f, bool invertY = false, bool tangent = true, bool showTopText = false,
                string bottomText = "");
    void updateTransformationMatrix();
...
class TableCell : public TableUIBase {
   ...
   public:
    ...
    TableCell(float angle = 0.0f, float distanceOffset = 0.075f, float openingAngle = 90, float thickness = 0.025f,
              bool clockwise = false, int id = 0, bool registerToEvents = true);
    void updateTransformationMatrix();
    void isHidden(bool is);
...
class TableSequencerCells : public TableUIBase {
   ...
   public:
    ...
    TableSequencerCells(float angle = 0.0f, float distanceOffset = 0.075f, int cellsNum = 5, float openingAngle = 180,
                        bool clockwise = true, float thickness = 0.04f);
    void updateTransformationMatrix();
    void isHidden(bool is);
...
class TableSequencerSliders : public TableUIBase {
   ...
   public:
    ...
    TableSequencerSliders(float angle = 0.0f, float distanceOffset = 0.075f, int cellsNum = 5, float openingAngle = 180,
                          float maxValue = 100.0f, float minValue = 0.0f, bool clockwise = true,
...
class TableInfoCircle : public TableUIBase {
   public:
    TableInfoCircle(float angle = 0.0f, float distanceOffset = 0.075f, float openingAngle = 180, bool clockwise = true,
                    bool discrete = true, int cellsNum = 3, float maxValue = 100.0f, float minValue = 0.0f);
